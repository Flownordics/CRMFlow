...
export const handler = async (event, context) => {
    ...
    try {
        ...
        console.log('PDF generator URL: https://crmflow-app.netlify.app/.netlify/functions/pdfgen');
        ...
        try {
            ...
            const netlifyFunctionUrl = 'https://crmflow-app.netlify.app/.netlify/functions/pdfgen';
