...
export function RecentInvoicesCard({ invoices, currency }: RecentInvoicesCardProps) {
...
function SimpleInvoiceTable({ ariaLabel, rows, currency, getCompanyName }: SimpleInvoiceTableProps) {
  return (
